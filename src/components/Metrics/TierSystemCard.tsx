    ...
    <Card className="bg-primary/5 border-primary/20">
      ...
      <CardContent className="text-sm text-muted-foreground">
        <div className="space-y-3">
          <div>
            <strong>Faixas de Score por Quadrante (NUNCA se sobrepõem):</strong>
          ...
          <div>
            ...
            <ul className="mt-1 ml-4 list-disc">
              <li>
                <strong>Base do Quadrante:</strong> Define a faixa (1000, 800 ou
                600)
              </li>
              <Conditional>
          ...
          {priorityMode === "time" && (
            <div className="p-2 bg-zinc-100 dark:bg-zinc-950/30 rounded text-zinc-800 dark:text-zinc-300">
              <strong>Exemplo:</strong> Desejo 4 + 10h (score ~890) SEMPRE vence
              Desejo 5 + 20h (score ~880) no modo Tempo.
            </div>
          )}
        </div>
      </CardContent>
